...
const MobileNavItem = ({
  ...
  active = false,
  onClick
}: MobileNavItemProps) => <button onClick={onClick} className={`p-2 transition-all flex flex-col items-center gap-1 ${active ? "text-primary scale-110" : "text-muted-foreground"}`}>
    {icon}
