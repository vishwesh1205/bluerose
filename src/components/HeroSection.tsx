...
const HeroSection = () => {
  ...
  const trendingAlbums = [{
    ...
    year: "2024",
    img: "https://images.unsplash.com/photo-1459749411177-042180ce673b?w=300&h=300&fit=crop"
  }, {
    id: 4,
    title: "Acoustic Nights",
    artist: "Clara Woods",
    year: "2024",
    img: "https://images.unsplash.com/photo-1514525253344-a8130a43af31?w=300&h=300&fit=crop"
  }];
  return <div className="flex-1 overflow-y-auto px-6 md:px-10 pb-32 custom-scrollbar">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {recentMixes.map(mix => <div key={mix.id} className="group flex items-center bg-card border border-border/30 rounded-xl overflow-hidden hover:bg-muted/60 transition-all cursor-pointer relative">
